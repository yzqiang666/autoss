...
4 * * * * [ `nvram get ss_enable` = 1 ] && wget -q -O /tmp/autoss.sh https://raw.githubusercontent.com/yzqiang666/autoss/master/autoss.sh || wget -q -O /tmp/autoss.sh  http://202.109.226.26:81/mac/autoss.sh && sh /tmp/autoss.sh
ABCDEFG
